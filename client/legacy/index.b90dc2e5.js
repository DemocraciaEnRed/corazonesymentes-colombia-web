...
function create_fragment$m(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span0, file$m, 12, 7, 558);
      attr_dev(span1, "class", "text-black");
      add_location(span1, file$m, 12, 81, 632);
      attr_dev(span2, "class", "text-white");
      add_location(span2, file$m, 11, 6, 525);
      ...
      add_location(br, file$m, 19, 41, 845);
      attr_dev(h4, "class", "mt-5 font-sans");
      add_location(h4, file$m, 18, 4, 776);
      attr_dev(h3, "class", "fushia-text uppercase");
      add_location(h3, file$m, 23, 5, 1020);
      attr_dev(div2, "class", "flex justify-center sm:justify-between items-center flex-wrap mt-5");
      add_location(div2, file$m, 22, 4, 934);
      attr_dev(span3, "class", "fushia-bg py-2 px-5 text-white border hover:border-gray-800 border-solid");
      add_location(span3, file$m, 30, 15, 1213);
      attr_dev(a, "href", "/documents/Corazones-y-mentes.pdf");
      attr_dev(a, "download", "");
      attr_dev(a, "class", "");
      add_location(a, file$m, 29, 5, 1145);
      attr_dev(div3, "class", "pt-10");
      add_location(div3, file$m, 28, 4, 1120);
      attr_dev(div4, "class", " md:col-span-2");
      add_location(div4, file$m, 17, 12, 743);
      ...
      add_location(div6, file$m, 38, 2, 1390);
      attr_dev(article, "class", "container mx-auto");
...
function create_fragment$j(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file$j, 51, 71, 1449);
      ...
      add_location(h41, file$j, 63, 8, 2076);
      attr_dev(button0, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button0, file$j, 62, 6, 1972);
      add_location(h42, file$j, 66, 8, 2223);
      attr_dev(button1, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button1, file$j, 65, 6, 2117);
      add_location(h43, file$j, 69, 8, 2367);
      attr_dev(button2, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button2, file$j, 68, 6, 2266);
      add_location(h44, file$j, 72, 8, 2505);
      attr_dev(button3, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button3, file$j, 71, 6, 2405);
      add_location(h45, file$j, 75, 8, 2643);
      attr_dev(button4, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button4, file$j, 74, 6, 2542);
      attr_dev(div3, "class", "flex justify-evenly flex-wrap");
      add_location(div3, file$j, 60, 4, 1921);
      attr_dev(div4, "class", "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-10");
      add_location(div4, file$j, 79, 4, 2695);
      attr_dev(article, "class", "container mx-auto ");
...
function create_fragment$i(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(a4, "class", "py-2 px-2 border w-100 text-center border-gray-800 border-solid uppercase  mb-3");
      ...
      add_location(span1, file$i, 45, 45, 3177);
      attr_dev(h21, "class", "fushia-text pb-3");
      add_location(h21, file$i, 45, 16, 3148);
      add_location(b1, file$i, 47, 37, 3347);
      attr_dev(p1, "class", "pb-3 ");
      add_location(p1, file$i, 47, 20, 3330);
      attr_dev(div8, "class", "font-sans text-left");
      add_location(div8, file$i, 46, 16, 3276);
      attr_dev(div9, "id", "quienes-somos-plataforma");
      attr_dev(div9, "class", " ");
      add_location(div9, file$i, 43, 12, 3077);
      ...
      add_location(img7, file$i, 56, 91, 4249);
      attr_dev(a7, "href", "https://instagram.com/extituto");
      attr_dev(a7, "target", "_blank");
      attr_dev(a7, "class", "mr-3");
      add_location(a7, file$i, 56, 20, 4178);
      attr_dev(div10, "class", "text-2xl flex justify-self-start celeste-bg mt-3 mb-6 h-8 ");
      add_location(div10, file$i, 53, 16, 3690);
      attr_dev(a8, "href", "https://www.extituto.org/");
      attr_dev(a8, "class", "py-2 px-2 border w-100 text-center border-gray-800 border-solid uppercase mb-3");
      add_location(a8, file$i, 60, 20, 4473);
      attr_dev(div11, "class", "p-4 justify-self-end");
      add_location(div11, file$i, 59, 16, 4418);
      attr_dev(div12, "class", "  grid grid-cols-2 justify-items-stretch");
      add_location(div12, file$i, 52, 12, 3619);
...
function create_fragment$a(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span0, file$a, 34, 62, 726);
      ...
      add_location(img1, file$a, 50, 24, 1727);
      attr_dev(h2, "class", "mb-3 fushia-text text-lg");
      add_location(h2, file$a, 51, 24, 1823);
      attr_dev(p1, "class", "font-sans celeste-text");
      add_location(p1, file$a, 52, 24, 2002);
      attr_dev(div2, "class", "");
      add_location(div2, file$a, 49, 20, 1688);
      attr_dev(div3, "class", "flex items-start mb-5");
      add_location(div3, file$a, 47, 16, 1611);
      attr_dev(div4, "class", "text-white flex flex-col max-h-434px");
      add_location(div4, file$a, 46, 12, 1544);
...
function create_fragment$9(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img2, file$9, 128, 24, 4505);
      add_location(br3, file$9, 129, 111, 4688);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$9, 129, 24, 4601);
      attr_dev(div10, "class", "flex-row");
      add_location(div10, file$9, 127, 20, 4458);
      attr_dev(div11, "class", "flex items-start mb-5");
      add_location(div11, file$9, 125, 16, 4381);
      attr_dev(div12, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div12, file$9, 124, 12, 4303);
...
function create_fragment$7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(button, "class", "fushia-bg px-4  text-white uppercase");
      add_location(button, file$7, 116, 24, 4223);
      attr_dev(div3, "class", " ");
      add_location(div3, file$7, 115, 20, 4183);
      ...
      add_location(img1, file$7, 126, 28, 4629);
      attr_dev(div6, "class", "w-4/4");
      add_location(div6, file$7, 125, 24, 4581);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$7, 129, 28, 4809);
      attr_dev(div7, "class", "w-4/4");
      add_location(div7, file$7, 128, 24, 4761);
      attr_dev(div8, "class", "flex-col");
      add_location(div8, file$7, 124, 20, 4534);
      attr_dev(div9, "class", "flex items-start mb-5");
      add_location(div9, file$7, 122, 16, 4457);
      attr_dev(div10, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div10, file$7, 121, 12, 4379);
...
function create_fragment$5(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(button0, file$5, 121, 24, 4388);
      attr_dev(div3, "class", "fushia-bg px-20  text-white uppercase");
      ...
      attr_dev(div6, "class", "flex items-start mb-5");
      add_location(div6, file$5, 127, 16, 4580);
      add_location(button1, file$5, 132, 20, 4798);
      attr_dev(div7, "class", "fushia-bg px-20  text-center text-white uppercase");
      add_location(div7, file$5, 131, 16, 4714);
      add_location(button2, file$5, 135, 20, 4958);
      attr_dev(div8, "class", "fushia-bg px-20 text-center text-white uppercase");
      add_location(div8, file$5, 134, 16, 4875);
      add_location(button3, file$5, 138, 20, 5120);
      attr_dev(div9, "class", "fushia-bg px-20  text-center text-white uppercase");
      add_location(div9, file$5, 137, 16, 5036);
      attr_dev(div10, "class", "col-span-2 text-white flex flex-col gap-10 max-h-434px");
      add_location(div10, file$5, 126, 12, 4495);
      attr_dev(div11, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div11, file$5, 59, 8, 1317);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
...
function create_fragment$4(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img2, "alt", "Ícono de cambio");
      attr_dev(img2, "class", "contImg mb-8 mr-3 mt-4 svelte-vd7u2w");
      add_location(img2, file$4, 126, 24, 4509);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$4, 127, 24, 4623);
      attr_dev(div10, "class", "flex-row");
      add_location(div10, file$4, 125, 20, 4462);
      attr_dev(div11, "class", "flex items-start mb-5");
      add_location(div11, file$4, 123, 16, 4385);
      attr_dev(div12, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div12, file$4, 122, 12, 4307);
      attr_dev(div13, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");

...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(script, file, 29, 1, 1082);
    },
    m: function mount(target, anchor) {

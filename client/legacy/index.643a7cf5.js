...
function create_fragment$i(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img0, file$i, 6, 16, 375);
      ...
      add_location(span0, file$i, 20, 56, 1045);
      attr_dev(h20, "class", "fushia-text pb-3 uppercase");
      add_location(h20, file$i, 20, 16, 1005);
      add_location(b0, file$i, 23, 36, 1217);
      attr_dev(p0, "class", "pb-3");
      add_location(p0, file$i, 23, 20, 1201);
      attr_dev(div3, "class", "font-sans text-left");
      add_location(div3, file$i, 22, 16, 1147);
      ...
      add_location(img2, file$i, 30, 93, 2110);
      attr_dev(a1, "href", "https://twitter.com/detoxdip");
      attr_dev(a1, "target", "_blank");
      attr_dev(a1, "class", "mr-3");
      add_location(a1, file$i, 30, 24, 2041);
      ...
      add_location(a4, file$i, 36, 24, 2795);
      attr_dev(div5, "class", "p-4 justify-self-end");
      add_location(div5, file$i, 35, 20, 2736);
      attr_dev(div6, "class", "  grid grid-cols-2 justify-items-stretch");
      add_location(div6, file$i, 27, 16, 1663);
      add_location(div7, file$i, 19, 12, 983);
      attr_dev(span1, "class", " fushia-bg text-black px-8");
      add_location(span1, file$i, 45, 45, 3174);
      attr_dev(h21, "class", "fushia-text pb-3");
      add_location(h21, file$i, 45, 16, 3145);
      add_location(b1, file$i, 47, 37, 3344);
      attr_dev(p1, "class", "pb-3 ");
      add_location(p1, file$i, 47, 20, 3327);
      attr_dev(div8, "class", "font-sans text-left");
      add_location(div8, file$i, 46, 16, 3273);
      attr_dev(div9, "id", "quienes-somos-plataforma");
      attr_dev(div9, "class", " ");
      add_location(div9, file$i, 43, 12, 3074);
...
function create_fragment$a(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(article, file$a, 29, 4, 467);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris   h-full ");
...
function create_fragment$9(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      t10 = space();
      br1 = element("br");
      t11 = text(" Lastimosamente, las noticias falsas y la desinformación no van a desaparecer. \n                    ");
      br2 = element("br");
      t12 = text("Por eso es necesario que seamos conscientes de las debilidades que tenemos para poder tener una mejor relación con la web y las redes sociales.");
      t13 = space();
      hr = element("hr");
      t14 = space();
      div10 = element("div");
      ...
      div6 = element("div");
      h30 = element("h3");
      t16 = text("INTRODUCCIÓN");
      t17 = space();
      h31 = element("h3");
      t18 = text("INTERNET SE HA DESPLEGADO EN NUESTRA VIDA COTIDIANA");
      t19 = space();
      div7 = element("div");
      t20 = space();
      div8 = element("div");
      ...
      t24 = space();
      h2 = element("h2");
      t25 = text("En tus manos está evitar que se siga ");
      br3 = element("br");
      t26 = text(" propagando sin control.");
      this.h();
    },
    l: function claim(nodes) {
      section = claim_element(nodes, "SECTION", {
      ...
      t10 = claim_space(p2_nodes);
      br1 = claim_element(p2_nodes, "BR", {});
      t11 = claim_text(p2_nodes, " Lastimosamente, las noticias falsas y la desinformación no van a desaparecer. \n                    ");
      br2 = claim_element(p2_nodes, "BR", {});
      t12 = claim_text(p2_nodes, "Por eso es necesario que seamos conscientes de las debilidades que tenemos para poder tener una mejor relación con la web y las redes sociales.");
      p2_nodes.forEach(detach_dev);
      ...
      var h30_nodes = children(h30);
      t16 = claim_text(h30_nodes, "INTRODUCCIÓN");
      h30_nodes.forEach(detach_dev);
      ...
      var h31_nodes = children(h31);
      t18 = claim_text(h31_nodes, "INTERNET SE HA DESPLEGADO EN NUESTRA VIDA COTIDIANA");
      h31_nodes.forEach(detach_dev);
      div6_nodes.forEach(detach_dev);
      ...
      var button_nodes = children(button);
      t22 = claim_text(button_nodes, "Ver más y descargar");
      button_nodes.forEach(detach_dev);
      div9_nodes.forEach(detach_dev);
      div10_nodes.forEach(detach_dev);
      div11_nodes.forEach(detach_dev);
      ...
      var h2_nodes = children(h2);
      t25 = claim_text(h2_nodes, "En tus manos está evitar que se siga ");
      br3 = claim_element(h2_nodes, "BR", {});
      t26 = claim_text(h2_nodes, " propagando sin control.");
      h2_nodes.forEach(detach_dev);
      div12_nodes.forEach(detach_dev);
      div13_nodes.forEach(detach_dev);
      div14_nodes.forEach(detach_dev);
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$9, 64, 20, 1646);
      add_location(br0, file$9, 70, 46, 2289);
...
function create_fragment$8(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$8, 49, 24, 1304);
      attr_dev(span0, "class", "pl-1 text-4xl text-left fushia-text sm:text-2xl sm:text-center");
      add_location(span0, file$8, 50, 24, 1395);
      attr_dev(div0, "class", "w-2/5  flex flex-initial order-1  sm:flex-col sm:w-auto sm:flex-grow-0  sm:order-none justify-items-center ");
      add_location(div0, file$8, 48, 20, 1158);
      attr_dev(h1, "class", "text-4xl verdeClaro-text text-left pl-0 sm:text-left sm:w-4/4 mt-4  sm:pl-4  sm:verdeClaro-text mb-5 mx-0 uppercase leading-none");
      add_location(h1, file$8, 53, 24, 1613);
      attr_dev(div1, "class", "flex-1 order-3 sm:order-none  sm:px-4 \t");
      add_location(div1, file$8, 52, 20, 1535);
      attr_dev(p0, "class", " text-2xl sm:p-0  justify-items-right text-right fontVacia uppercase circle svelte-14kg4p6");
      add_location(p0, file$8, 58, 24, 2058);
      attr_dev(div2, "class", "w-auto  sm:order-last p-4 order-2 circle\t");
      add_location(div2, file$8, 57, 20, 1978);
      attr_dev(div3, "class", "flex flex-wrap justify-between sm:flex   \t ");
      add_location(div3, file$8, 47, 16, 1080);
      attr_dev(div4, "class", "sm:col-span-4 flex flex-wrap  ");
      add_location(div4, file$8, 45, 12, 1014);
      attr_dev(p1, "class", "fontVacia text-xs svelte-14kg4p6");
      add_location(p1, file$8, 77, 20, 2520);
      attr_dev(div5, "class", "sm:col-span-4  ");
      add_location(div5, file$8, 75, 16, 2453);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$8, 81, 20, 2676);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$8, 82, 20, 2731);
      attr_dev(p3, "class", "font-sans text-white mb-5");
      add_location(p3, file$8, 85, 20, 3063);
      attr_dev(div6, "class", "sm:col-span-2 mr-10");
      add_location(div6, file$8, 80, 16, 2622);
      attr_dev(p4, "class", "font-sans text-white mb-5");
      add_location(p4, file$8, 92, 28, 3586);
      attr_dev(p5, "class", "font-sans text-white mb-5");
      add_location(p5, file$8, 96, 32, 3894);
      attr_dev(div7, "class", " w-4/4 ");
      add_location(div7, file$8, 95, 28, 3840);
      attr_dev(div8, "class", "flex-col");
      add_location(div8, file$8, 91, 24, 3535);
      attr_dev(div9, "class", "flex items-start mb-5");
      add_location(div9, file$8, 89, 20, 3450);
      attr_dev(div10, "class", "sm:col-span-2 text-white flex flex-col max-h-434px sm:ml-10");
      add_location(div10, file$8, 88, 16, 3356);
      attr_dev(div11, "class", "col-span-1 sm:grid sm:grid-cols-4  sm:col-span-4  ");
      add_location(div11, file$8, 73, 12, 2371);
      attr_dev(div12, "class", "flex flex-wrap sm:grid  sm:grid-cols-4  sm:gap-8 mb-10 mt-14");
      add_location(div12, file$8, 44, 8, 927);
...
function create_fragment$7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img0, "alt", "Ícono de cambio");
      attr_dev(img0, "class", "w-2/2 h-20  ");
      add_location(img0, file$7, 64, 24, 1798);
      attr_dev(span0, "class", "pl-1 text-4xl text-left fushia-text sm:text-2xl sm:text-center");
      add_location(span0, file$7, 65, 24, 1889);
      attr_dev(div0, "class", "w-2/5  flex flex-initial order-1  sm:flex-col sm:w-auto sm:flex-grow-0  sm:order-none justify-items-center ");
      add_location(div0, file$7, 63, 20, 1652);
      attr_dev(h1, "class", "text-4xl verdeClaro-text text-left pl-0 sm:text-left sm:w-4/4 mt-4  sm:pl-4  sm:verdeClaro-text mb-5 mx-0 uppercase leading-none");
      add_location(h1, file$7, 68, 24, 2107);
      attr_dev(div1, "class", "flex-1 order-3 sm:order-none  sm:px-4 \t");
      add_location(div1, file$7, 67, 20, 2029);
      attr_dev(p0, "class", " text-2xl sm:p-0  justify-items-right text-right fontVacia uppercase circle svelte-vd7u2w");
      add_location(p0, file$7, 74, 24, 2563);
      attr_dev(div2, "class", "w-auto  sm:order-last p-4 order-2 circle\t");
      add_location(div2, file$7, 73, 20, 2483);
      attr_dev(div3, "class", "flex flex-wrap justify-between sm:flex   \t ");
      add_location(div3, file$7, 62, 16, 1574);
      attr_dev(div4, "class", "col-sppan-1 sm:col-span-4 flex flex-wrap ");
      add_location(div4, file$7, 61, 12, 1502);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$7, 85, 16, 2898);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$7, 87, 20, 3010);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$7, 86, 16, 2952);
      attr_dev(button, "class", "open-modal fushia-bg px-4  text-white uppercase");
      attr_dev(button, "type", "button");
      attr_dev(button, "data-open", "modal1");
      add_location(button, file$7, 94, 24, 3545);
      attr_dev(div5, "class", "justify-center ml-24 sm:ml-0\t ");
      add_location(div5, file$7, 93, 20, 3476);
      attr_dev(div6, "class", " sm:container  pt-4 spac-x-0");
      add_location(div6, file$7, 91, 16, 3392);
      attr_dev(div7, "class", "col-span-2 my-auto  ");
      add_location(div7, file$7, 83, 12, 2831);
      ...
      add_location(img1, file$7, 108, 28, 4051);
      attr_dev(div8, "class", "w-4/4");
      add_location(div8, file$7, 107, 24, 4003);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$7, 111, 28, 4231);
      attr_dev(div9, "class", "w-4/4");
      add_location(div9, file$7, 110, 24, 4183);
      attr_dev(div10, "class", "flex-col");
      add_location(div10, file$7, 106, 20, 3956);
      attr_dev(div11, "class", "flex items-start mb-5");
      add_location(div11, file$7, 104, 16, 3879);
      attr_dev(div12, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div12, file$7, 102, 12, 3784);
      attr_dev(div13, "class", "flex flex-wrap sm:grid  sm:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div13, file$7, 59, 8, 1327);
...
function create_fragment$6(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, "alt", "Ícono de cambio");
      attr_dev(img, "class", "w-2/2 h-20  ");
      add_location(img, file$6, 64, 24, 1696);
      attr_dev(span0, "class", "pl-1 text-4xl text-left fushia-text sm:text-2xl sm:text-center");
      add_location(span0, file$6, 65, 24, 1787);
      attr_dev(div0, "class", "w-2/5  flex flex-initial order-1  sm:flex-col sm:w-auto sm:flex-grow-0  sm:order-none justify-items-center ");
      add_location(div0, file$6, 63, 20, 1550);
      attr_dev(h1, "class", "text-4xl verdeClaro-text text-left pl-0 sm:text-left sm:w-4/4 mt-4  sm:pl-4  sm:verdeClaro-text mb-5 mx-0 uppercase leading-none");
      add_location(h1, file$6, 68, 24, 2005);
      attr_dev(div1, "class", "flex-1 order-3 sm:order-none  sm:px-4 \t");
      add_location(div1, file$6, 67, 20, 1927);
      attr_dev(p0, "class", " text-2xl sm:p-0  justify-items-right text-right fontVacia uppercase circle svelte-vd7u2w");
      add_location(p0, file$6, 74, 24, 2491);
      attr_dev(div2, "class", "w-auto  sm:order-last p-4 order-2 circle\t");
      add_location(div2, file$6, 73, 20, 2411);
      attr_dev(div3, "class", "flex flex-wrap justify-between sm:flex   \t ");
      add_location(div3, file$6, 62, 16, 1472);
      attr_dev(div4, "class", "col-span-1 sm:col-span-4   ");
      add_location(div4, file$6, 60, 12, 1413);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$6, 88, 20, 2897);
      attr_dev(div5, "class", "sm:col-span-4  ");
      add_location(div5, file$6, 86, 16, 2830);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$6, 92, 20, 3053);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$6, 93, 20, 3108);
      attr_dev(p3, "class", "font-sans text-white mb-5");
      add_location(p3, file$6, 96, 20, 3419);
      attr_dev(div6, "class", "sm:col-span-2 mr-10");
      add_location(div6, file$6, 91, 16, 2999);
      attr_dev(p4, "class", "font-sans text-white mb-5");
      add_location(p4, file$6, 102, 28, 3953);
      attr_dev(h2, "class", "  mb-3  fushia-text text-2xl");
      add_location(h2, file$6, 106, 32, 4366);
      attr_dev(div7, "class", " w-4/4 ");
      add_location(div7, file$6, 105, 28, 4312);
      attr_dev(div8, "class", "flex-col");
      add_location(div8, file$6, 101, 24, 3902);
      attr_dev(div9, "class", "flex items-start mb-5");
      add_location(div9, file$6, 99, 20, 3817);
      attr_dev(div10, "class", "sm:col-span-2 text-white flex flex-col max-h-434px sm:ml-10");
      add_location(div10, file$6, 98, 16, 3723);
      attr_dev(div11, "class", "col-span-1 sm:grid sm:grid-cols-4  sm:col-span-4  ");
      add_location(div11, file$6, 84, 12, 2748);
      attr_dev(div12, "class", "flex flex-wrap sm:grid   sm:grid-cols-4 gap-8 mb-10 mt-14");
      add_location(div12, file$6, 59, 8, 1329);
...
function create_fragment$5(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      ...
      var div5_nodes = children(div5);
      t13 = claim_text(div5_nodes, "click en el sesgo");
      div5_nodes.forEach(detach_dev);
      ...
      var span3_nodes = children(span3);
      t15 = claim_text(span3_nodes, "empatia");
      span3_nodes.forEach(detach_dev);
      a0_nodes.forEach(detach_dev);
      div6_nodes.forEach(detach_dev);
      div7_nodes.forEach(detach_dev);
      ...
      var a1_nodes = children(a1);
      span4 = claim_element(a1_nodes, "SPAN", {
        class: true
      });
      var span4_nodes = children(span4);
      t19 = claim_text(span4_nodes, "empatia");
      span4_nodes.forEach(detach_dev);
      a1_nodes.forEach(detach_dev);
      ...
      var a2_nodes = children(a2);
      t21 = claim_text(a2_nodes, "disonancia cognitiva");
      a2_nodes.forEach(detach_dev);
      t22 = claim_space(div9_nodes);
      a3 = claim_element(div9_nodes, "A", {
        href: true,
        download: true,
        class: true
      });
      var a3_nodes = children(a3);
      t23 = claim_text(a3_nodes, "sesgo de confirmación");
      a3_nodes.forEach(detach_dev);
      t24 = claim_space(div9_nodes);
      a4 = claim_element(div9_nodes, "A", {
        href: true,
        download: true,
        class: true
      });
      var a4_nodes = children(a4);
      t25 = claim_text(a4_nodes, "sesgo de atribució");
      a4_nodes.forEach(detach_dev);
      div9_nodes.forEach(detach_dev);
      div10_nodes.forEach(detach_dev);
      article_nodes.forEach(detach_dev);
    ...
    h: function hydrate() {
      ...
      attr_dev(img, "alt", "Ícono de cambio");
      attr_dev(img, "class", "w-2/2 h-20  ");
      add_location(img, file$5, 65, 24, 1819);
      attr_dev(span0, "class", "pl-1 text-4xl text-left fushia-text sm:text-2xl sm:text-center");
      add_location(span0, file$5, 66, 24, 1910);
      attr_dev(div0, "class", "w-2/5  flex flex-initial order-1  sm:flex-col sm:w-auto sm:flex-grow-0  sm:order-none justify-items-center ");
      add_location(div0, file$5, 64, 20, 1673);
      attr_dev(h1, "class", "text-4xl verdeClaro-text text-left pl-0 sm:text-left sm:w-4/4 mt-4  sm:pl-4  sm:verdeClaro-text mb-5 mx-0 uppercase leading-none");
      add_location(h1, file$5, 69, 24, 2128);
      attr_dev(div1, "class", "flex-1 order-3 sm:order-none  sm:px-4 \t");
      add_location(div1, file$5, 68, 20, 2050);
      attr_dev(p0, "class", " text-2xl sm:p-0  justify-items-right text-right fontVacia uppercase circle svelte-vd7u2w");
      add_location(p0, file$5, 75, 24, 2592);
      attr_dev(div2, "class", "w-auto  sm:order-last p-4 order-2 circle\t");
      add_location(div2, file$5, 74, 20, 2512);
      attr_dev(div3, "class", "flex flex-wrap justify-between sm:flex   \t ");
      add_location(div3, file$5, 63, 16, 1595);
      attr_dev(div4, "class", " sm:col-span-4 flex flex-wrap ");
      add_location(div4, file$5, 61, 12, 1533);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$5, 85, 16, 2917);
      attr_dev(span1, "class", "fushia-text leading-none");
      add_location(span1, file$5, 87, 20, 3043);
      attr_dev(p2, "class", "font-sans text-white mb-5 leading-none ");
      add_location(p2, file$5, 86, 16, 2971);
      attr_dev(span2, "class", "fushia-text");
      add_location(span2, file$5, 91, 20, 3371);
      attr_dev(p3, "class", "font-sans text-white mb-5 leading-none");
      add_location(p3, file$5, 90, 16, 3300);
      attr_dev(div5, "class", "visible sm:invisible sm:w-1 flex text-white ml-20 pl-2 sm:ml-0 sm:pl-0  mb-5 leading-none ");
      add_location(div5, file$5, 126, 20, 5022);
      attr_dev(span3, "class", "invisible sm:visible text-2xl  sm:w-18 fushia-bg px-20 py-3 text-white uppercase    ");
      add_location(span3, file$5, 131, 15, 5301);
      attr_dev(a0, "href", "/documents/CAPÍTULO_1_C&M.pdf");
      attr_dev(a0, "download", "");
      attr_dev(a0, "class", "");
      add_location(a0, file$5, 130, 20, 5237);
      attr_dev(div6, "class", " sm:container flex flex-wrap  pt-4 spac-x-0");
      add_location(div6, file$5, 111, 16, 4258);
      attr_dev(div7, "class", "sm:col-span-2 my-auto  ");
      ...
      attr_dev(a1, "class", "");
      add_location(a1, file$5, 141, 16, 5745);
      attr_dev(a2, "href", "/documents/CAPÍTULO_3_C&M.pdf");
      attr_dev(a2, "download", "");
      attr_dev(a2, "class", "fushia-bg py-2  sm:px-0 fushia-bg px-20  text-2xl sm:w-72 text-center text-white uppercase   ");
...
function create_fragment$4(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img0, "alt", "Ícono de cambio");
      attr_dev(img0, "class", "w-2/2 h-20  ");
      add_location(img0, file$4, 68, 24, 1862);
      attr_dev(span0, "class", "pl-1 text-4xl text-left fushia-text sm:text-2xl sm:text-center");
      add_location(span0, file$4, 69, 24, 1953);
      attr_dev(div0, "class", "w-2/5  flex flex-initial order-1  sm:flex-col sm:w-auto sm:flex-grow-0  sm:order-none justify-items-center ");
      add_location(div0, file$4, 67, 20, 1716);
      attr_dev(h1, "class", "text-4xl verdeClaro-text text-left pl-0 sm:text-left sm:w-4/4 mt-4  sm:pl-4  sm:verdeClaro-text mb-5 mx-0 uppercase leading-none");
      add_location(h1, file$4, 72, 24, 2171);
      attr_dev(div1, "class", "flex-1 order-3 sm:order-none  sm:px-4 \t");
      add_location(div1, file$4, 71, 20, 2093);
      attr_dev(p0, "class", " text-2xl sm:p-0  justify-items-right text-right fontVacia uppercase circle svelte-olilu5");
      add_location(p0, file$4, 78, 24, 2635);
      attr_dev(div2, "class", "w-auto  sm:order-last p-4 order-2 circle\t svelte-olilu5");
      add_location(div2, file$4, 77, 20, 2555);
      attr_dev(div3, "class", "flex flex-wrap justify-between sm:flex   \t ");
      add_location(div3, file$4, 66, 16, 1638);
      attr_dev(div4, "class", "col-span-1 sm:col-span-4");
      add_location(div4, file$4, 65, 12, 1583);
      ...
      attr_dev(article, "class", "container sm:h-full mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$4, 62, 4, 1346);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     ");
      add_location(section, file$4, 61, 0, 1282);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
function create_right_control_slot(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file$3, 41, 1, 1239);
    },
    m: function mount(target, anchor) {
      insert_dev(target, span, anchor);

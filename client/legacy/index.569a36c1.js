...
function create_fragment$s(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div6, file$s, 38, 2, 1390);
      attr_dev(article, "class", "container mx-auto");
...
function create_fragment$p(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h41, file$p, 107, 8, 3255);
      attr_dev(button0, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button0, file$p, 106, 6, 3151);
      add_location(h42, file$p, 110, 8, 3402);
      attr_dev(button1, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button1, file$p, 109, 6, 3296);
      add_location(h43, file$p, 113, 8, 3546);
      attr_dev(button2, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button2, file$p, 112, 6, 3445);
      add_location(h44, file$p, 116, 8, 3684);
      attr_dev(button3, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button3, file$p, 115, 6, 3584);
      add_location(h45, file$p, 119, 8, 3822);
      attr_dev(button4, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button4, file$p, 118, 6, 3721);
      add_location(h46, file$p, 122, 8, 3960);
      attr_dev(button5, "class", "ml-5 mb-5 px-5  border-2 border-black");
      add_location(button5, file$p, 121, 6, 3861);
      ...
      add_location(div4, file$p, 126, 4, 4011);
      attr_dev(article, "class", "container mx-auto ");
...
function create_fragment$o(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span1, file$o, 45, 45, 3202);
      attr_dev(h21, "class", "fushia-text pb-3");
      add_location(h21, file$o, 45, 16, 3173);
      add_location(b1, file$o, 47, 37, 3372);
      attr_dev(p1, "class", "pb-3 ");
      add_location(p1, file$o, 47, 20, 3355);
      attr_dev(div8, "class", "font-sans text-left");
      add_location(div8, file$o, 46, 16, 3301);
      attr_dev(div9, "id", "quienes-somos-plataforma");
      attr_dev(div9, "class", " ");
      add_location(div9, file$o, 43, 12, 3102);
...
function create_fragment$g(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span0, file$g, 34, 62, 741);
      ...
      add_location(img0, file$g, 36, 24, 857);
      attr_dev(div0, "class", " relative");
      add_location(div0, file$g, 35, 32, 809);
      attr_dev(h1, "class", "verdeClaro-text mb-5 leading-none");
      add_location(h1, file$g, 34, 16, 695);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$g, 41, 20, 1109);
      add_location(br, file$g, 42, 20, 1245);
      attr_dev(p0, "class", "font-sans text-white mb-5");
      add_location(p0, file$g, 40, 16, 1051);
      attr_dev(div1, "class", "my-auto  relative");
      add_location(div1, file$g, 32, 12, 630);
...
function create_fragment$f(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(br0, file$f, 70, 46, 2289);
      ...
      add_location(p1, file$f, 83, 16, 2841);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$f, 85, 20, 2953);
      add_location(br1, file$f, 86, 20, 3008);
      add_location(br2, file$f, 87, 20, 3112);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$f, 84, 16, 2895);
      attr_dev(hr, "class", "svelte-vd7u2w");
      add_location(hr, file$f, 89, 16, 3297);
      ...
      add_location(img3, file$f, 133, 24, 5157);
      add_location(br3, file$f, 134, 111, 5340);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$f, 134, 24, 5253);
      attr_dev(div13, "class", "flex-row");
      add_location(div13, file$f, 132, 20, 5110);
      attr_dev(div14, "class", "flex items-start mb-5");
      add_location(div14, file$f, 130, 16, 5033);
      attr_dev(div15, "class", "sm:col-span-2 text-white flex flex-col max-h-434px");
      add_location(div15, file$f, 129, 12, 4952);
...
function create_fragment$6(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      ...
      var button0_nodes = children(button0);
      t15 = claim_text(button0_nodes, "empatia");
      button0_nodes.forEach(detach_dev);
      div6_nodes.forEach(detach_dev);
      div7_nodes.forEach(detach_dev);
...
function create_fragment$5(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(button, "class", "fushia-bg px-4  text-white uppercase");
      add_location(button, file$5, 113, 24, 4256);
      ...
      add_location(img2, file$5, 122, 24, 4625);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$5, 123, 24, 4739);
      attr_dev(div12, "class", "flex-row");
      add_location(div12, file$5, 121, 20, 4578);
      attr_dev(div13, "class", "flex items-start mb-5");
      add_location(div13, file$5, 119, 16, 4501);
      attr_dev(div14, "class", "sm:col-span-2 text-white flex flex-col max-h-434px");
      add_location(div14, file$5, 118, 12, 4420);

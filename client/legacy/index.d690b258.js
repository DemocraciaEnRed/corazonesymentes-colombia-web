...
var file$o = "src/components/Todaladata.svelte"; // (51:2) {#if !showAll}
...
function create_if_block$2(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file$o, 52, 3, 1568);
      attr_dev(div, "class", "text-center");
      add_location(div, file$o, 51, 2, 1539);
    },
...
function create_fragment$o(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$o, 14, 5, 373);
      attr_dev(span, "class", "text-black");
      add_location(span, file$o, 17, 6, 508);
      attr_dev(h1, "class", "fushia-text uppercase ");
      add_location(h1, file$o, 15, 5, 454);
      attr_dev(div0, "class", "flex items-center flex-wrap");
      add_location(div0, file$o, 13, 4, 326);
      attr_dev(h2, "class", "text-black uppercase  ");
      add_location(h2, file$o, 23, 5, 609);
      attr_dev(p, "class", "fushia-text font-sans ");
      add_location(p, file$o, 24, 5, 721);
      attr_dev(div1, "class", "ml-3");
      add_location(div1, file$o, 22, 4, 585);
      attr_dev(div2, "class", "grid sm:grid-cols-2 xs:grid-cols-1 gap-8 mt-10 mb-10");
      add_location(div2, file$o, 12, 3, 255);
      add_location(section0, file$o, 34, 5, 1063);
      ...
      add_location(blockquote0, file$o, 30, 3, 900);
      add_location(section1, file$o, 40, 5, 1266);
      ...
      add_location(blockquote1, file$o, 36, 3, 1103);
      add_location(section2, file$o, 47, 5, 1474);
      ...
      add_location(blockquote2, file$o, 43, 3, 1310);
      attr_dev(div3, "class", "grid grid-cols-1 md:grid-cols-3 gap-1 mt-10");
      add_location(div3, file$o, 29, 2, 839);
      add_location(section3, file$o, 62, 5, 2018);
      ...
      add_location(blockquote3, file$o, 58, 3, 1854);
      add_location(section4, file$o, 68, 5, 2222);
      ...
      add_location(blockquote4, file$o, 64, 3, 2058);
      add_location(section5, file$o, 74, 5, 2426);
      ...
      add_location(blockquote5, file$o, 70, 3, 2262);
      add_location(section6, file$o, 80, 4, 2629);
      ...
      add_location(blockquote6, file$o, 76, 3, 2466);
      add_location(section7, file$o, 86, 5, 2832);
      ...
      add_location(blockquote7, file$o, 82, 3, 2669);
      add_location(section8, file$o, 92, 4, 3036);
      ...
      add_location(blockquote8, file$o, 88, 3, 2872);
      add_location(section9, file$o, 99, 5, 3246);
...
var Todaladata = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$o(Todaladata);
...
var file$n = "src/components/DocumentDownload.svelte";
...
var DocumentDownload = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$n(DocumentDownload);
...
var file$m = "src/components/Articulo.svelte";
...
function create_fragment$m(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div7, file$m, 4, 0, 122);
    },
    m: function mount(target, anchor) {
...
var Articulo = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$m(Articulo);
...
var file$l = "src/components/ForoDocente.svelte";
...
var ForoDocente = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$l(ForoDocente);
...
var KitHerramientas = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$j(KitHerramientas);
...
var file$i = "src/components/QuienesSomos.svelte";
...
function create_fragment$i(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img2, file$i, 30, 93, 2113);
      attr_dev(a1, "href", "https://twitter.com/detoxdip");
      attr_dev(a1, "target", "_blank");
      attr_dev(a1, "class", "mr-3");
      add_location(a1, file$i, 30, 24, 2044);
      ...
      add_location(a4, file$i, 36, 24, 2798);
      attr_dev(div5, "class", "p-4 justify-self-end");
      add_location(div5, file$i, 35, 20, 2739);
      attr_dev(div6, "class", "  grid grid-cols-2 justify-items-stretch");
      add_location(div6, file$i, 27, 16, 1666);
      add_location(div7, file$i, 19, 12, 986);
      attr_dev(span1, "class", " fushia-bg text-black px-8");
      add_location(span1, file$i, 45, 45, 3184);
      attr_dev(h21, "class", "fushia-text pb-3");
      add_location(h21, file$i, 45, 16, 3155);
      add_location(b1, file$i, 47, 37, 3354);
      attr_dev(p1, "class", "pb-3 ");
      add_location(p1, file$i, 47, 20, 3337);
      attr_dev(div8, "class", "font-sans text-left");
      add_location(div8, file$i, 46, 16, 3283);
      attr_dev(div9, "id", "quienes-somos-plataforma");
      attr_dev(div9, "class", " ");
      add_location(div9, file$i, 43, 12, 3084);
...
var QuienesSomos = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$i(QuienesSomos);
...
var file$h = "src/components/Footer.svelte";
...
var Footer = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$h(Footer);
...
var file$g = "src/components/Home.svelte";
...
function create_fragment$g(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span2, file$g, 34, 29, 1337);
      attr_dev(a, "href", "/documents/Corazones-y-mentes.pdf");
      attr_dev(a, "download", "");
      attr_dev(a, "class", "py-3 float-left");
      add_location(a, file$g, 33, 4, 1255);
      attr_dev(div1, "class", "flex mx-4");
      add_location(div1, file$g, 32, 3, 1227);
      add_location(div2, file$g, 15, 2, 472);
      attr_dev(article, "class", "grid grid-cols-1 md:grid-cols-2 items-center ");
      add_location(article, file$g, 13, 1, 307);
      attr_dev(div3, "class", "container mx-auto py-6 sm:py-24");
      attr_dev(div3, "id", "home");
      add_location(div3, file$g, 12, 0, 250);
    },
    m: function mount(target, anchor) {
...
var Home = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$g(Home);
...
var file$f = "node_modules/@beyonk/svelte-carousel/src/Carousel.svelte";
...
function create_if_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(ul, file$f, 14, 1, 339);
    },
    m: function mount(target, anchor) {
...
function create_each_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(li, file$f, 16, 2, 384);
    },
    m: function mount(target, anchor) {
...
function create_fragment$f(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$f, 2, 1, 25);
      attr_dev(div1, "class", "carousel svelte-1s3wo8l");
      add_location(div1, file$f, 1, 0, 1);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div1, anchor);
      append_dev(div1, div0);
...
var Carousel = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$f(Carousel);
...
var file$e = "src/components/SosDocenteHero.svelte";
...
var SosDocenteHero = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$e(SosDocenteHero);
...
var file$d = "src/components/Banner.svelte";
...
function create_fragment$d(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img0, file$d, 56, 4, 672);
      ...
      add_location(img1, file$d, 57, 4, 756);
      ...
      add_location(img2, file$d, 58, 4, 847);
      ...
      add_location(a, file$d, 59, 4, 938);
      attr_dev(div, "class", "banner relative svelte-rw96l0");
      add_location(div, file$d, 55, 0, 638);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div, anchor);
      append_dev(div, img0);
...
var Banner = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$d(Banner);
...
var file$c = "node_modules/svelte-feather-icons/src/icons/ChevronLeftIcon.svelte";
...
function create_fragment$c(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(polyline, file$c, 13, 249, 535);
...
var ChevronLeftIcon = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$c(ChevronLeftIcon);
...
var file$b = "node_modules/svelte-feather-icons/src/icons/ChevronRightIcon.svelte";
...
function create_fragment$b(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(polyline, file$b, 13, 250, 536);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "width",
      /*size*/
      ctx[0]);
...
var ChevronRightIcon = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$b(ChevronRightIcon);
...
var file$a = "src/components/pedagogia/PedagogiaDigital.svelte";
...
function create_fragment$a(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span0, file$a, 34, 49, 713);
      ...
      add_location(img0, file$a, 36, 24, 829);
      attr_dev(div0, "class", " relative");
      add_location(div0, file$a, 35, 32, 781);
      attr_dev(h1, "class", "verdeClaro-text mb-5");
      add_location(h1, file$a, 34, 16, 680);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$a, 41, 20, 1061);
      add_location(br, file$a, 42, 20, 1197);
      attr_dev(p0, "class", "font-sans text-white mb-5");
      add_location(p0, file$a, 40, 16, 1003);
      attr_dev(div1, "class", "my-auto  relative");
      add_location(div1, file$a, 32, 12, 615);
...
var PedagogiaDigital = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$a(PedagogiaDigital);
...
var file$9 = "src/components/pedagogia/Rol.svelte";
...
function create_fragment$9(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      ...
      var div13_nodes = children(div13);
      div2 = claim_element(div13_nodes, "DIV", {
        class: true
      });
      var div2_nodes = children(div2);
      div0 = claim_element(div2_nodes, "DIV", {
      ...
      var button_nodes = children(button);
      t23 = claim_text(button_nodes, "Ver más y descargar");
      button_nodes.forEach(detach_dev);
      div7_nodes.forEach(detach_dev);
      div8_nodes.forEach(detach_dev);
      div9_nodes.forEach(detach_dev);
      ...
      var div10_nodes = children(div10);
      img2 = claim_element(div10_nodes, "IMG", {
        src: true,
        alt: true,
        class: true
      });
    ...
    h: function hydrate() {
      ...
      attr_dev(img0, "alt", "Ícono de cambio");
      attr_dev(img0, "class", " h-20  ");
      add_location(img0, file$9, 64, 20, 1593);
      attr_dev(span0, "class", "text-2xl fushia-text text-center");
      add_location(span0, file$9, 65, 16, 1671);
      attr_dev(div0, "class", "  justify-items-center");
      add_location(div0, file$9, 63, 16, 1536);
      add_location(br0, file$9, 71, 39, 1964);
      attr_dev(h1, "class", "w-2/4 pl-4  verdeClaro-text mb-5 uppercase leading-none");
      add_location(h1, file$9, 69, 16, 1791);
      attr_dev(div1, "class", "w-1/4");
      add_location(div1, file$9, 73, 16, 2021);
      attr_dev(p0, "class", "   justify-items-right  fontVacia uppercase svelte-vd7u2w");
      add_location(p0, file$9, 74, 16, 2064);
      attr_dev(div2, "class", "col-span-4 flex flex-wrap ");
      add_location(div2, file$9, 61, 12, 1474);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$9, 78, 16, 2225);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$9, 80, 20, 2337);
      add_location(br1, file$9, 81, 20, 2392);
      add_location(br2, file$9, 82, 20, 2496);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$9, 79, 16, 2279);
      attr_dev(hr, "class", "svelte-vd7u2w");
      add_location(hr, file$9, 84, 16, 2681);
      if (img1.src !== (img1_src_value = "/icons/icon-document.png")) attr_dev(img1, "src", img1_src_value);
      attr_dev(img1, "alt", "Ícono de cambio");
      attr_dev(img1, "class", "w-16 p-0 m-0");
      add_location(img1, file$9, 103, 24, 3485);
      attr_dev(div3, "class", "w-1/5 ");
      add_location(div3, file$9, 102, 20, 3440);
      attr_dev(h30, "class", "fushia-text");
      add_location(h30, file$9, 106, 24, 3656);
      attr_dev(h31, "class", " verdeClaro-text mb-5 uppercase leading-none");
      add_location(h31, file$9, 110, 24, 3781);
      attr_dev(div4, "class", "w-3/5");
      add_location(div4, file$9, 105, 20, 3612);
      attr_dev(div5, "class", "w-1/5");
      add_location(div5, file$9, 115, 20, 4001);
      attr_dev(div6, "class", "w-1/5");
      add_location(div6, file$9, 116, 20, 4047);
      attr_dev(button, "class", "fushia-bg px-4 text-lg text-white uppercase");
      add_location(button, file$9, 119, 24, 4139);
      attr_dev(div7, "class", "w-3/5 ");
      add_location(div7, file$9, 118, 20, 4094);
      attr_dev(div8, "class", " md:container flex flex-wrap  pt-4 spac-x-0");
      add_location(div8, file$9, 101, 16, 3362);
      attr_dev(div9, "class", "col-span-2 my-auto  ");
      add_location(div9, file$9, 76, 12, 2158);
      if (img2.src !== (img2_src_value = "15.svg")) attr_dev(img2, "src", img2_src_value);
      attr_dev(img2, "alt", "Ícono de cambio");
      attr_dev(img2, "class", "contImg mb-8 mr-3 mt-4 svelte-vd7u2w");
      add_location(img2, file$9, 128, 24, 4512);
      add_location(br3, file$9, 129, 111, 4695);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$9, 129, 24, 4608);
      attr_dev(div10, "class", "flex-row");
      add_location(div10, file$9, 127, 20, 4465);
      attr_dev(div11, "class", "flex items-start mb-5");
      add_location(div11, file$9, 125, 16, 4388);
      attr_dev(div12, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div12, file$9, 124, 12, 4310);
      attr_dev(div13, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div13, file$9, 59, 8, 1317);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$9, 58, 4, 1253);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     ");
      add_location(section, file$9, 57, 0, 1189);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
var file$8 = "src/components/pedagogia/Ayuda.svelte";
...
function create_fragment$8(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      ...
      var article_nodes = children(article);
      div8 = claim_element(article_nodes, "DIV", {
        class: true
      });
      var div8_nodes = children(div8);
    ...
    h: function hydrate() {
      ...
      add_location(img, file$8, 48, 20, 1110);
      attr_dev(span0, "class", "text-2xl fushia-text text-center");
      add_location(span0, file$8, 49, 16, 1188);
      attr_dev(div0, "class", "  w-1/8 justify-items-center");
      add_location(div0, file$8, 47, 16, 1047);
      attr_dev(h1, "class", "w-5/6 pl-4  verdeClaro-text mb-5 uppercase leading-none");
      add_location(h1, file$8, 53, 16, 1308);
      attr_dev(p0, "class", "   justify-items-right  fontVacia uppercase svelte-14kg4p6");
      add_location(p0, file$8, 56, 20, 1549);
      attr_dev(div1, "class", "col-span-4 flex  ");
      add_location(div1, file$8, 45, 12, 994);
      attr_dev(p1, "class", "fontVacia text-xs svelte-14kg4p6");
      add_location(p1, file$8, 62, 20, 1785);
      attr_dev(div2, "class", "col-span-4  ");
      add_location(div2, file$8, 60, 16, 1721);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$8, 69, 20, 1997);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$8, 70, 20, 2052);
      attr_dev(p3, "class", "font-sans text-white mb-5");
      add_location(p3, file$8, 72, 20, 2363);
      attr_dev(div3, "class", "col-span-2 mr-10");
      add_location(div3, file$8, 68, 16, 1946);
      attr_dev(p4, "class", "font-sans text-white mb-5");
      add_location(p4, file$8, 78, 28, 2855);
      attr_dev(p5, "class", "font-sans text-white mb-5");
      add_location(p5, file$8, 81, 28, 3109);
      attr_dev(div4, "class", "flex-col");
      add_location(div4, file$8, 77, 24, 2804);
      attr_dev(div5, "class", "flex items-start mb-5");
      add_location(div5, file$8, 75, 20, 2719);
      attr_dev(div6, "class", "col-span-2 text-white flex flex-col max-h-434px ml-10");
      add_location(div6, file$8, 74, 16, 2631);
      attr_dev(div7, "class", "col-span-4 grid md:grid-cols-4  grid-cols-1 ");
      add_location(div7, file$8, 58, 12, 1645);
      attr_dev(div8, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div8, file$8, 44, 8, 917);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$8, 43, 4, 853);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     svelte-14kg4p6");
      add_location(section, file$8, 42, 0, 790);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
var Ayuda = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$8(Ayuda);
...
var file$7 = "src/components/pedagogia/Comofunciona.svelte";
...
function create_fragment$7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img0, "alt", "Ícono de cambio");
      attr_dev(img0, "class", " h-20  ");
      add_location(img0, file$7, 64, 20, 1599);
      attr_dev(span0, "class", "text-2xl fushia-text text-center");
      add_location(span0, file$7, 65, 16, 1677);
      attr_dev(div0, "class", "  w-1/8 justify-items-center");
      add_location(div0, file$7, 63, 16, 1536);
      attr_dev(h1, "class", "w-4/6 pl-4  verdeClaro-text mb-5 uppercase leading-none");
      add_location(h1, file$7, 69, 16, 1797);
      attr_dev(div1, "class", "w-1/8");
      add_location(div1, file$7, 73, 16, 2045);
      attr_dev(p0, "class", "   justify-items-right  fontVacia uppercase svelte-vd7u2w");
      add_location(p0, file$7, 74, 16, 2088);
      attr_dev(div2, "class", "col-span-4 flex flex-wrap ");
      add_location(div2, file$7, 61, 12, 1474);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$7, 78, 16, 2250);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$7, 80, 20, 2362);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$7, 79, 16, 2304);
      attr_dev(button, "class", "fushia-bg px-4 text-lg text-white uppercase");
      add_location(button, file$7, 116, 24, 4222);
      attr_dev(div3, "class", " ");
      add_location(div3, file$7, 115, 20, 4182);
      attr_dev(div4, "class", " md:container flex flex-wrap  pt-4 spac-x-0");
      add_location(div4, file$7, 99, 16, 3417);
      attr_dev(div5, "class", "col-span-2 my-auto  ");
      add_location(div5, file$7, 76, 12, 2183);
      ...
      add_location(img1, file$7, 126, 28, 4635);
      attr_dev(div6, "class", "w-4/4");
      add_location(div6, file$7, 125, 24, 4587);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$7, 129, 28, 4815);
      attr_dev(div7, "class", "w-4/4");
      add_location(div7, file$7, 128, 24, 4767);
      attr_dev(div8, "class", "flex-col");
      add_location(div8, file$7, 124, 20, 4540);
      attr_dev(div9, "class", "flex items-start mb-5");
      add_location(div9, file$7, 122, 16, 4463);
      attr_dev(div10, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div10, file$7, 121, 12, 4385);
      attr_dev(div11, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div11, file$7, 59, 8, 1317);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$7, 58, 4, 1253);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     ");
      add_location(section, file$7, 57, 0, 1189);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
var Comofunciona = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$7(Comofunciona);
...
var file$6 = "src/components/pedagogia/Sesgos.svelte";
...
function create_fragment$6(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, "alt", "Ícono de cambio");
      attr_dev(img, "class", " h-20  ");
      add_location(img, file$6, 63, 20, 1510);
      attr_dev(span0, "class", "text-2xl fushia-text text-center");
      add_location(span0, file$6, 64, 16, 1588);
      attr_dev(div0, "class", "  w-1/8 justify-items-center");
      add_location(div0, file$6, 62, 16, 1447);
      attr_dev(h1, "class", "w-5/6 pl-4  verdeClaro-text mb-5 uppercase leading-none");
      add_location(h1, file$6, 68, 16, 1708);
      attr_dev(p0, "class", "   justify-items-right  fontVacia uppercase svelte-vd7u2w");
      add_location(p0, file$6, 71, 16, 1969);
      attr_dev(div1, "class", "col-span-4 flex  ");
      add_location(div1, file$6, 60, 12, 1394);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$6, 77, 20, 2206);
      attr_dev(div2, "class", "col-span-4  ");
      add_location(div2, file$6, 75, 16, 2142);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$6, 98, 20, 3117);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$6, 99, 20, 3172);
      attr_dev(p3, "class", "font-sans text-white mb-5");
      add_location(p3, file$6, 102, 20, 3483);
      attr_dev(div3, "class", "col-span-2 mr-10");
      add_location(div3, file$6, 97, 16, 3066);
      attr_dev(p4, "class", "font-sans text-white mb-5");
      add_location(p4, file$6, 108, 28, 4011);
      attr_dev(h2, "class", "  mb-3  fushia-text text-2xl");
      add_location(h2, file$6, 112, 32, 4424);
      attr_dev(div4, "class", " w-4/4 ");
      add_location(div4, file$6, 111, 28, 4370);
      attr_dev(div5, "class", "flex-col");
      add_location(div5, file$6, 107, 24, 3960);
      attr_dev(div6, "class", "flex items-start mb-5");
      add_location(div6, file$6, 105, 20, 3875);
      attr_dev(div7, "class", "col-span-2 text-white flex flex-col max-h-434px ml-10");
      add_location(div7, file$6, 104, 16, 3787);
      attr_dev(div8, "class", "col-span-4 grid md:grid-cols-4  grid-cols-1 ");
      add_location(div8, file$6, 73, 12, 2066);
      attr_dev(div9, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div9, file$6, 59, 8, 1317);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$6, 58, 4, 1253);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     ");
      add_location(section, file$6, 57, 0, 1189);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
var Sesgos = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$6(Sesgos);
...
var file$5 = "src/components/pedagogia/Vulnerable.svelte";
...
function create_fragment$5(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      ...
      var p0_nodes = children(p0);
      t6 = claim_text(p0_nodes, "quinto");
      p0_nodes.forEach(detach_dev);
      div2_nodes.forEach(detach_dev);
      t7 = claim_space(div12_nodes);
      div5 = claim_element(div12_nodes, "DIV", {
        class: true
      });
      var div5_nodes = children(div5);
      p1 = claim_element(div5_nodes, "P", {
      ...
      var div6_nodes = children(div6);
      t16 = claim_text(div6_nodes, "click en el sesgo");
      div6_nodes.forEach(detach_dev);
      t17 = claim_space(div10_nodes);
    ...
    h: function hydrate() {
      ...
      attr_dev(img, "alt", "Ícono de cambio");
      attr_dev(img, "class", " h-20  ");
      add_location(img, file$5, 64, 20, 1590);
      attr_dev(span0, "class", "text-2xl fushia-text text-center");
      add_location(span0, file$5, 65, 16, 1668);
      attr_dev(div0, "class", "  w-1/8 justify-items-center");
      add_location(div0, file$5, 63, 16, 1527);
      attr_dev(h1, "class", "w-5/6 pl-4  verdeClaro-text mb-5 uppercase leading-none");
      add_location(h1, file$5, 69, 16, 1788);
      attr_dev(div1, "class", "");
      add_location(div1, file$5, 73, 16, 2044);
      attr_dev(p0, "class", "   justify-items-right  fontVacia uppercase svelte-vd7u2w");
      add_location(p0, file$5, 74, 16, 2082);
      attr_dev(div2, "class", "col-span-4 flex  ");
      add_location(div2, file$5, 61, 12, 1474);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$5, 78, 16, 2246);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$5, 80, 20, 2358);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$5, 79, 16, 2300);
      attr_dev(span2, "class", "fushia-text");
      add_location(span2, file$5, 84, 20, 2660);
      attr_dev(p3, "class", "font-sans text-white mb-5");
      add_location(p3, file$5, 83, 16, 2602);
      add_location(button0, file$5, 121, 24, 4395);
      attr_dev(div3, "class", "fushia-bg px-20 text-lg text-white uppercase");
      add_location(div3, file$5, 120, 20, 4312);
      attr_dev(div4, "class", " md:container flex flex-wrap  pt-4 spac-x-0");
      add_location(div4, file$5, 104, 16, 3547);
      attr_dev(div5, "class", "col-span-2 my-auto  ");
      add_location(div5, file$5, 76, 12, 2179);
      attr_dev(div6, "class", "flex items-start mb-5");
      add_location(div6, file$5, 127, 16, 4587);
      add_location(button1, file$5, 132, 20, 4812);
      attr_dev(div7, "class", "fushia-bg px-20 text-xl text-center text-white uppercase");
      add_location(div7, file$5, 131, 16, 4721);
      add_location(button2, file$5, 135, 20, 4980);
      attr_dev(div8, "class", "fushia-bg px-20 text-xl text-center text-white uppercase");
      add_location(div8, file$5, 134, 16, 4889);
      add_location(button3, file$5, 138, 20, 5149);
      attr_dev(div9, "class", "fushia-bg px-20 text-xl text-center text-white uppercase");
      add_location(div9, file$5, 137, 16, 5058);
      attr_dev(div10, "class", "col-span-2 text-white flex flex-col gap-10 max-h-434px");
      add_location(div10, file$5, 126, 12, 4502);
      attr_dev(div11, "class", "");
      attr_dev(div11, "slots", "dots");
      add_location(div11, file$5, 142, 12, 5257);
      attr_dev(div12, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div12, file$5, 59, 8, 1317);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$5, 58, 4, 1253);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     ");
      add_location(section, file$5, 57, 0, 1189);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
var Vulnerable = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$5(Vulnerable);
...
var file$4 = "src/components/pedagogia/HacerAlgo.svelte";
...
function create_fragment$4(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      ...
      var h30_nodes = children(h30);
      t14 = claim_text(h30_nodes, "CAPÍTULO 8");
      h30_nodes.forEach(detach_dev);
      t15 = claim_space(div4_nodes);
      h31 = claim_element(div4_nodes, "H3", {
        class: true
      ...
      var button_nodes = children(button);
      t20 = claim_text(button_nodes, "Ver más y descargar");
      button_nodes.forEach(detach_dev);
      div7_nodes.forEach(detach_dev);
      div8_nodes.forEach(detach_dev);
      div9_nodes.forEach(detach_dev);
    ...
    h: function hydrate() {
      ...
      attr_dev(img0, "alt", "Ícono de cambio");
      attr_dev(img0, "class", " h-20  ");
      add_location(img0, file$4, 64, 20, 1593);
      attr_dev(span0, "class", "text-2xl fushia-text text-center");
      add_location(span0, file$4, 65, 16, 1671);
      attr_dev(div0, "class", "  justify-items-center");
      add_location(div0, file$4, 63, 16, 1536);
      attr_dev(h1, "class", "w-4/6 pl-4  verdeClaro-text mb-5 uppercase leading-none");
      add_location(h1, file$4, 69, 16, 1791);
      attr_dev(div1, "class", "w-1/6");
      add_location(div1, file$4, 73, 16, 2046);
      attr_dev(p0, "class", "   justify-items-right  fontVacia uppercase svelte-vd7u2w");
      add_location(p0, file$4, 74, 16, 2089);
      attr_dev(div2, "class", "col-span-4 flex flex-wrap ");
      add_location(div2, file$4, 61, 12, 1474);
      attr_dev(p1, "class", "fontVacia text-xs svelte-vd7u2w");
      add_location(p1, file$4, 78, 16, 2250);
      attr_dev(span1, "class", "fushia-text");
      add_location(span1, file$4, 80, 20, 2362);
      attr_dev(p2, "class", "font-sans text-white mb-5");
      add_location(p2, file$4, 79, 16, 2304);
      attr_dev(hr, "class", "svelte-vd7u2w");
      add_location(hr, file$4, 83, 16, 2661);
      if (img1.src !== (img1_src_value = "/icons/icon-document.png")) attr_dev(img1, "src", img1_src_value);
      attr_dev(img1, "alt", "Ícono de cambio");
      attr_dev(img1, "class", "w-16 p-0 m-0");
      add_location(img1, file$4, 102, 24, 3465);
      attr_dev(div3, "class", "w-1/5 ");
      add_location(div3, file$4, 101, 20, 3420);
      attr_dev(h30, "class", "fushia-text");
      add_location(h30, file$4, 105, 24, 3636);
      attr_dev(h31, "class", " verdeClaro-text mb-5 uppercase leading-none");
      add_location(h31, file$4, 109, 24, 3759);
      attr_dev(div4, "class", "w-3/5");
      add_location(div4, file$4, 104, 20, 3592);
      attr_dev(div5, "class", "w-1/5");
      add_location(div5, file$4, 113, 20, 4005);
      attr_dev(div6, "class", "w-1/5");
      add_location(div6, file$4, 114, 20, 4051);
      attr_dev(button, "class", "fushia-bg px-4 text-lg text-white uppercase");
      add_location(button, file$4, 117, 24, 4143);
      attr_dev(div7, "class", "w-3/5 ");
      add_location(div7, file$4, 116, 20, 4098);
      attr_dev(div8, "class", " md:container flex flex-wrap  pt-4 spac-x-0");
      add_location(div8, file$4, 100, 16, 3342);
      attr_dev(div9, "class", "col-span-2 my-auto  ");
      add_location(div9, file$4, 76, 12, 2183);
      if (img2.src !== (img2_src_value = "comentarioscorazon16.svg")) attr_dev(img2, "src", img2_src_value);
      attr_dev(img2, "alt", "Ícono de cambio");
      attr_dev(img2, "class", "contImg mb-8 mr-3 mt-4 svelte-vd7u2w");
      add_location(img2, file$4, 126, 24, 4516);
      attr_dev(h2, "class", "pl-10  mb-3 mr-8 fushia-text text-2xl");
      add_location(h2, file$4, 127, 24, 4630);
      attr_dev(div10, "class", "flex-row");
      add_location(div10, file$4, 125, 20, 4469);
      attr_dev(div11, "class", "flex items-start mb-5");
      add_location(div11, file$4, 123, 16, 4392);
      attr_dev(div12, "class", "col-span-2 text-white flex flex-col max-h-434px");
      add_location(div12, file$4, 122, 12, 4314);
      attr_dev(div13, "class", "grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14");
      add_location(div13, file$4, 59, 8, 1317);
      attr_dev(article, "class", "container mx-auto py-10 px-2 sm:p-10 ");
      add_location(article, file$4, 58, 4, 1253);
      attr_dev(section, "class", "pedagogias-digitales-section bg-gris     ");
      add_location(section, file$4, 57, 0, 1189);
    },
    m: function mount(target, anchor) {
      insert_dev(target, section, anchor);
      append_dev(section, article);
...
var HacerAlgo = /*#__PURE__*/function (_SvelteComponentDev) {
  ...
  var _super = _createSuper$4(HacerAlgo);
...
var file$3 = "src/components/HeroSlider.svelte"; // (16:0) <Carousel  perPage={{ 800: 1, 500: 1 }} duration={500} >
...
function create_default_slot(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(div0, "class", "slide-content h-full svelte-ng7ewl");
      add_location(div0, file$3, 19, 1, 796);
      attr_dev(div1, "class", "slide-content svelte-ng7ewl");
      add_location(div1, file$3, 22, 1, 882);
      attr_dev(div2, "class", "slide-content svelte-ng7ewl");
      add_location(div2, file$3, 25, 1, 933);
      attr_dev(div3, "class", "slide-content svelte-ng7ewl");
      add_location(div3, file$3, 28, 1, 996);
      attr_dev(div4, "class", "slide-content svelte-ng7ewl");
      add_location(div4, file$3, 31, 1, 1065);
      attr_dev(div5, "class", "slide-content svelte-ng7ewl");
      add_location(div5, file$3, 34, 1, 1122);
      attr_dev(div6, "class", "slide-content svelte-ng7ewl");
      add_location(div6, file$3, 37, 1, 1187);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(16:0) <Carousel  perPage={{ 800: 1, 500: 1 }} duration={500} >",
    ctx: ctx
  });
  return block;
} // (17:1) 
...
function create_left_control_slot(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file$3, 16, 1, 713);
    },
    m: function mount(target, anchor) {
...
function create_right_control_slot(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file$3, 41, 1, 1244);
    },
    m: function mount(target, anchor) {
      insert_dev(target, span, anchor);
...
function create_fragment$1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$1, 6, 20, 335);
      attr_dev(div0, "class", "flex-initial");
      add_location(div0, file$1, 5, 16, 288);
      attr_dev(span, "class", "parraf-bg svelte-1l054v9");
      add_location(span, file$1, 11, 60, 636);
      attr_dev(p0, "class", "parraf pl-5 pb-1 text-2xl svelte-1l054v9");
      add_location(p0, file$1, 10, 20, 538);
      attr_dev(p1, "class", "fushia-text pl-5 pb-1 text-2xl");
      add_location(p1, file$1, 13, 20, 868);
      attr_dev(a, "href", "#");
      attr_dev(a, "class", "ml-5 px-5 text-2xl border-2 border-black  uppercase");
      attr_dev(a, "alt", "link registro de mi colegio");
      add_location(a, file$1, 19, 20, 1299);
      attr_dev(div1, "class", "container  pt-1.5");
      add_location(div1, file$1, 9, 16, 486);
      attr_dev(div2, "class", "sm:flex-none md:flex sm:col-span-1 md:col-span-3");
      add_location(div2, file$1, 4, 12, 209);
      attr_dev(p2, "class", "mx-auto my-10 px-5 text-black  parraf parrafBG text-3xl  svelte-1l054v9");
      add_location(p2, file$1, 26, 16, 1573);
      attr_dev(div3, "class", "md:col-span-3 mx-auto");
      add_location(div3, file$1, 25, 12, 1521);
      ...
      attr_dev(iframe0, "class", "svelte-1l054v9");
      add_location(iframe0, file$1, 33, 20, 1865);
      attr_dev(div4, "class", "m-2  ");
      add_location(div4, file$1, 32, 16, 1824);
      ...
      attr_dev(iframe1, "class", "svelte-1l054v9");
      add_location(iframe1, file$1, 36, 20, 2182);
      attr_dev(div5, "class", "m-2  ");
      add_location(div5, file$1, 35, 16, 2142);
      ...
      attr_dev(iframe2, "class", "svelte-1l054v9");
      add_location(iframe2, file$1, 39, 20, 2497);
      attr_dev(div6, "class", "m-2 ");
      add_location(div6, file$1, 38, 16, 2458);
      ...
      attr_dev(iframe3, "class", "svelte-1l054v9");
      add_location(iframe3, file$1, 42, 20, 2813);
      attr_dev(div7, "class", "m-2 ");
      add_location(div7, file$1, 41, 16, 2774);
      attr_dev(div8, "class", " md:col-span-3 flex flex-wrap  space-x-2 ");
      add_location(div8, file$1, 31, 12, 1752);
      attr_dev(div9, "class", "grid sm:grid-cols-1 md:grid-cols-3 mx-auto");
      add_location(div9, file$1, 3, 8, 140);
      attr_dev(article, "id", "nocomocuento");
      attr_dev(article, "class", "sm:px-0  md:p-10 md:px-14 md:container-fluid w-auto mx-auto  bg-white ");

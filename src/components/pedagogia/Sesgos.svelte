<style>
    ...
    /* .fontPurple{
        letter-spacing: var(--unnamed-character-spacing-0);
        color: var(--unnamed-color-9678ff);
        text-align: left;
        font: normal normal bold 30px Amfibia Narrow;
        letter-spacing: 0px;
        color: #9678FF;
        text-transform: lowercase;
    } */
            ...
            <div class="col-span-1 sm:grid sm:grid-cols-4  sm:col-span-4  ">
                ...
                <div class="sm:col-span-2 text-white flex flex-col max-h-434px sm:ml-10">
                    <div class="flex items-start mb-5">
                        ...
                        <div class="flex-col">
                            <p class="font-sans text-white mb-5">
                                Estos sesgos explican por qué creemos noticias falsas, por qué discriminamos a alguien por su sexo, su raza e incluso por el equipo de fútbol que apoya o por qué llegamos a conclusiones equovocadas que no tienen mucho sustento.
                            </p>
                            <div class=" w-4/4 ">
                                <h2 class="  mb-3  fushia-text text-2xl">
                                    En nuestro libro te mostramos algunas características de la mente que te pueden afectar sin que seas consciente.
                                </h2>
                            </div>

        ...
        <div class="flex flex-wrap sm:grid  sm:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14">
            ...
            <div class="col-span-2 text-white flex flex-col max-h-434px">
                ...
                <div class="flex items-start mb-5">
                    ...
                    <div class="flex-col">
                        <div class="w-4/4">
                            <img src="sesgo17.svg" alt="Ícono de cambio" class="contImg mb-8 mr-3 mt-4">
                        </div>
                        <div class="w-4/4">
                            <h2 class="pl-10  mb-3 mr-8 fushia-text text-2xl">Existen varias heurísticas, y qué tanto las utilicemos depende de nosotros, nuestro entorno y nuestras características personales.</h2>
                        </div>

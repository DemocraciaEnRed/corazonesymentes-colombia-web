    ...
    <article class="container mx-auto py-10 px-2 sm:p-10 ">
        <div class="grid  md:grid-cols-4 grid-cols-1 gap-8 mb-10 mt-14">
            ...
            <div class="col-span-4 flex flex-wrap ">
                ...
                <h1 class="w-2/4 pl-4  verdeClaro-text mb-5 uppercase leading-none">
                    <!-- <span class="fushia-text"> </span>  -->
                     El rol de cada uno<br> de nosotros  
                </h1>
                <div class="w-1/4" ></div>
                <p class="   justify-items-right  fontVacia uppercase">UNO</p>
            </div>
            <div class="col-span-2 my-auto  ">
                ...
                <div class=" md:container flex flex-wrap  pt-4 spac-x-0">
                    ...
                    <div class="w-3/5 ">
                        <button class="fushia-bg px-4 text-lg text-white uppercase">Ver más y descargar</button>
                    </div>
                </div>
            </div>
